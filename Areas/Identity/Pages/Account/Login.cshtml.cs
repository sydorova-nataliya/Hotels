...
namespace hotelcourseworkV2.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (roles.Contains("Зарегистрированный клиент"))
                    {
                        return RedirectToAction("Guest", "Guest");
                    }
                    else if (roles.Contains("Владелец сети"))
                    {
                    ...
                    else if (roles.Contains("Сотрудник рецепции"))
                    {
                        return RedirectToAction("Reseption", "Reseption");
                    }
                    else if (roles.Contains("Повар в отеле"))
                    {
